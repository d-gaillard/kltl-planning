...
grammar.py
Description:
    A module for checking the satisfaction of KLTL formulae.  
"""

from typing import List, Tuple, Union

from kltl_types import AtomicProposition

from system.parametric_transition_system import ParametricTransitionSystem
